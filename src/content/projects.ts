...
export type Project = {
  ...
  /** Two to four per project, driven by the reader through the arrows. */
...
export const projects: readonly Project[] = [
  {
    ...
    slides: [
      ...
      },
      {
        kind: 'image',
        image: images.ariva1,
        alt: 'The ARIVA case list, filtered by status, category and country, with each case showing its processing state.',
      },
      {
        kind: 'image',
        image: images.ariva2,
        alt: 'A new ARIVA case: the extracted fields on the left, the scanned request letter they were read from on the right.',
      },
      {
        kind: 'image',
        image: images.ariva3,
        alt: 'ARIVA splitting a collected PDF into six separate letters and processing them one after another.',
      },
    ],
  },
  {
    ...
    slides: [
      ...
      {
        kind: 'image',
        image: images.viegtorApp1,
        alt: 'The Viegtor landing screen, a compass rendered against black under the line Find your north.',
      },
      {
        kind: 'image',
        image: images.viegtorApp2,
        alt: 'A Viegtor signal broken into inputs, four scored analysis panels, and the build, invest or ignore scenarios beneath them.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    slides: [
      ...
      {
        kind: 'image',
        image: images.sanfoTrust,
        alt: 'The San Fo trust and safety page, KYC on the investor side and KYB on the business side of every deal.',
      },
    ],
  },
]
